...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SeriesActionTypes", function() { return SeriesActionTypes; });
...
/* harmony import */ var _services_series_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/series.service */ "./src/app/services/series.service.ts");
/* harmony import */ var _effects_series_effect__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./effects/series.effect */ "./src/app/effects/series.effect.ts");
/* harmony import */ var _reducers_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./reducers/index */ "./src/app/reducers/index.ts");
...
/* harmony import */ var _params_truncate_pipe__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./params/truncate.pipe */ "./src/app/params/truncate.pipe.ts");
/* harmony import */ var ngx_bar_rating__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngx-bar-rating */ "./node_modules/ngx-bar-rating/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            jw_angular_pagination__WEBPACK_IMPORTED_MODULE_6__["JwPaginationComponent"],
            _components_cart_cart_component__WEBPACK_IMPORTED_MODULE_12__["CartComponent"],
            _params_truncate_pipe__WEBPACK_IMPORTED_MODULE_13__["TruncatePipe"],
        ...
        imports: [
            ...
            _ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["EffectsModule"].forRoot([_effects_series_effect__WEBPACK_IMPORTED_MODULE_8__["SeriesEffect"]]),
...
/* harmony import */ var _actions_series_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../actions/series.actions */ "./src/app/actions/series.actions.ts");
...
let HeaderComponent = class HeaderComponent {
    ...
    ngOnInit() {
        ...
        this.subscription = this.searchField.valueChanges
            ...
            .subscribe(term => {
            (!this.searchField.value) ? this.store.dispatch(new _actions_series_actions__WEBPACK_IMPORTED_MODULE_5__["Load"]()) :
                this.store['loaded'] = true;
            this.store['series'] = [];
            this.store.dispatch(new _actions_series_actions__WEBPACK_IMPORTED_MODULE_5__["Search"](this.searchField.value));
        });
...
/* harmony import */ var _services_series_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/series.service */ "./src/app/services/series.service.ts");
/* harmony import */ var _actions_series_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../actions/series.actions */ "./src/app/actions/series.actions.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SeriesEffect", function() { return SeriesEffect; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _ngrx_effects__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ngrx/effects */ "./node_modules/@ngrx/effects/fesm2015/effects.js");
/* harmony import */ var _reducers_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../reducers/index */ "./src/app/reducers/index.ts");
/* harmony import */ var _services_series_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/series.service */ "./src/app/services/series.service.ts");
/* harmony import */ var _actions_series_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../actions/series.actions */ "./src/app/actions/series.actions.ts");
...
/* harmony import */ var rxjs_internal_observable_empty__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs/internal/observable/empty */ "./node_modules/rxjs/internal/observable/empty.js");
/* harmony import */ var rxjs_internal_observable_empty__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(rxjs_internal_observable_empty__WEBPACK_IMPORTED_MODULE_9__);
...
let SeriesEffect = class SeriesEffect {
    constructor(SeriesService, action$, store) {
        this.SeriesService = SeriesService;
        this.action$ = action$;
        this.store = store;
        this.loadSeries$ = this.action$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["ofType"])(_actions_series_actions__WEBPACK_IMPORTED_MODULE_7__["SeriesActionTypes"].Load), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["withLatestFrom"])(this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_reducers_index__WEBPACK_IMPORTED_MODULE_5__["getLoaded"]))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(([, loaded]) => {
            if (loaded) {
                return Object(rxjs_internal_observable_empty__WEBPACK_IMPORTED_MODULE_9__["empty"])();
            }
            return this.SeriesService.getAllSeries().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(series => {
                return new _actions_series_actions__WEBPACK_IMPORTED_MODULE_7__["LoadSuccess"](series);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs_internal_observable_of__WEBPACK_IMPORTED_MODULE_8__["of"])(new _actions_series_actions__WEBPACK_IMPORTED_MODULE_7__["LoadFail"](err))));
        }));
        this.search$ = this.action$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["ofType"])(_actions_series_actions__WEBPACK_IMPORTED_MODULE_7__["SeriesActionTypes"].Search), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(({ payload }) => {
            return this.SeriesService.getSeriesSearch(payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(series => {
                return new _actions_series_actions__WEBPACK_IMPORTED_MODULE_7__["LoadSuccess"](series);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => Object(rxjs_internal_observable_of__WEBPACK_IMPORTED_MODULE_8__["of"])(new _actions_series_actions__WEBPACK_IMPORTED_MODULE_7__["LoadFail"](err))));
        }));
    }
};
SeriesEffect.ctorParameters = () => [
...
], SeriesEffect.prototype, "loadSeries$", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_4__["Effect"])()
], SeriesEffect.prototype, "search$", void 0);
SeriesEffect = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _reducers_series_reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../reducers/series.reducer */ "./src/app/reducers/series.reducer.ts");
...
const getSeriesFeatureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])('seriesFeature');
const getSeries = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(getSeriesFeatureState, state => {
    return state.series;
});
const getLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(getSeriesFeatureState, state => {
    return state.loaded;
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SeriesReducer", function() { return SeriesReducer; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _actions_series_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../actions/series.actions */ "./src/app/actions/series.actions.ts");
...
function SeriesReducer(state = initialState, action) {
    switch (action.type) {
        case _actions_series_actions__WEBPACK_IMPORTED_MODULE_1__["SeriesActionTypes"].LoadSuccess:
            return Object.assign({}, state, { series: [...action.payload], loaded: true, error: '' });
        default:
            return state;
    }
}
...
let SeriesService = class SeriesService {
    ...
    getAllSeries() {
        return this.http.get(`${this.seriesUrl}shows`)
    ...
    getSeriesSearch(phrase) {
        return this.http.get(`${this.seriesUrl}search/shows?q=${phrase}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((data) => {
...
module.exports = __webpack_require__(/*! C:\Users\Ja\Desktop\Angular\serialeTV2\src\main.ts */"./src/main.ts");
